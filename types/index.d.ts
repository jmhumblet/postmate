 ...
 */
 declare class Postmate extends Promise<Postmate.ParentAPI> {
  ...
  /**
   * The maximum number of attempts to send a handshake request to the parent. Default : 5
   * @type {Number}
   */
...
declare namespace Postmate {
    ...
    interface PostmateOptions {
        ...
        /**
         * An object used to log chidl/parent interaction
         */
        logger?: Logger;
    }
    ...
    class Model extends Promise<ChildAPI> {
         ...
         */
        constructor(model: any, logger?: Logger);
    }
    interface Logger {
        debug: Function;
        error: Function;
